...
public class WelcomePageObject extends MainPageObject {
    private static final String
            ...
            STEP_NEW_WAYS_FOR_EXPLORE_TEXT = "id:New ways to explore",
    ...
    public void waitForNewWayToExploreText() {
        this.waitForElementPresent(STEP_NEW_WAYS_FOR_EXPLORE_TEXT, "Cannot find 'New ways to explore' link", 10);
    }
